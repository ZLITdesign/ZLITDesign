;(function (factory) {
  ...
  var cssSelector = {
    ...
    'prev': '.icon-prev',
    'next': '.icon-next',
    'actualSize': '.icon-shuaxin',
    'rotateLeft': '.icon-zuoxuan',
    'rotateRight': '.icon-youxuan',
    'loader': '.icon-loader',
    'btn': '.magnify-btn'
  };
  var defaults = {
    ...
    keyboard: false,
    title: true,
    Toolbar: ['prev', 'next', 'zoomIn', 'actualSize', 'zoomOut', 'rotateLeft', 'rotateRight'],
    i18n: {
      close: '关闭',
      zoomIn: '放大(+)',
      zoomOut: '缩小(-)',
  ...
  magnify.prototype = {
    init: function (ele) {
      ...
      var btnTpl = {
        zoomIn: '<a href="javascript:void(0)" class="magnify-btn iconfont icon-fd" title="' + this.settings.i18n.zoomIn + '"></a>',
        zoomOut: '<a href="javascript:void(0)" class="magnify-btn iconfont icon-sx" title="' + this.settings.i18n.zoomOut + '"></a>',
        prev: '<a href="javascript:void(0)" class="magnify-btn iconfont icon-prev" title="' + this.settings.i18n.prev + '"></a>',
        next: '<a href="javascript:void(0)" class="magnify-btn iconfont icon-next" title="' + this.settings.i18n.next + '"></a>',
        actualSize: '<a href="javascript:void(0)" class="magnify-btn iconfont icon-shuaxin" title="' + this.settings.i18n.actualSize + '"></a>',
        rotateLeft: '<a href="javascript:void(0)" class="magnify-btn iconfont icon-zuoxuan" title="' + this.settings.i18n.rotateLeft + '"></a>',
        rotateRight: '<a href="javascript:void(0)" class="magnify-btn iconfont icon-youxuan" title="' + this.settings.i18n.rotateRight + '"></a>'
      };
      return '<div class="magnify-modal">' +
        '<div class="magnify-header">' + this.createTitle() +
        '<a href="javascript:void(0)" class="iconfont icon-guanbi" title="' + this.settings.i18n.close + '"></a>' +
        '</div>' +
      ...
      if (this.settings.bigView){
        modalWidth = '100%';
        modalHeight = '100%';
        $('.magnify-modal').css({left:0,top:0})
      }else{
      ...
      if (this.settings.bigView){
        if (!this.isRotated) {
          scale = Math.min(stageData.w / img.width, stageData.h / img.height, 1.8);
        } else {
      ...
      if (this.isRotated && tag === 'jump') {
        this.$image.css({left: (stageData.w - this.$image.width()) / 2, top: (stageData.h - this.$image.height()) / 2})
      } else {
        this.$image.css({
      ...
      var self = this;
      var loadHTML = '<div class="iconfont icon-loader"></div>';
      ...
      var self = this, isDragging = false, startX = 0, startY = 0, left = 0, top = 0, widthDiff = 0, heightDiff = 0,
        gt = 0;
