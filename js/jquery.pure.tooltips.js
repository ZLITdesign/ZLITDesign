...
(function($) {
	...
	$.pt = $.pureToolTips1 = function(options) {
        ...
        $pt.removeClass().addClass('pt ' + (arrow ? arrowClass : '')).find('.cont').html(opts.content).css({width:opts.width, height:opts.height, color:opts.fontcolor});
      }
  ...
  $.dt = $.pureToolTips1 = function(options) {
    ...
    function init() {
      ...
      if (!opts.fontcolor){
        $dt.removeClass().addClass('dt ' + (arrow ? arrowClass : '')).find('.cont').html(opts.content).css({width:opts.width, height:opts.height});
      }else{
        $dt.removeClass().addClass('dt ' + (arrow ? arrowClass : '')).find('.cont').html(opts.content).css({width:opts.width, height:opts.height, color:opts.fontcolor});
      }
